...
root1 = BinaryTree().deserialize('[1,2,7,3,4,8,9,5,6,null,null,10,null,11,12]')
root2 = BinaryTree().deserialize('[1,2,7,3,4,8,9,5,6,null,null,10,null,11,12]')

# BinaryTree().drawtree(root)
print(Solution().getTargetCopy(root1, root2, 9))